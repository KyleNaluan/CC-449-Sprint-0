...
public class Rational {
	...
	/**
	 * 	Reduces this Rational's numerator and denominator to the simplest
	 * 	form using the GCD.
	 */
	private void reduce()
	{
	...
	/**
	 * 	Returns the greatest commond divisor (GCD) of the two given numbers.
	 * 	The GCD is the highest number that divides both of the given values.
	 */
	...
	/**
	 * 	Returns a String representation of the Rational in simplest form.
	 * 	If the denominator is 1, then this returns a whole number. If the
	 * 	Rational is equal to zero, then this returns zero. Otherwise, the
	 *	Rational is shown in simplest form with the negative sign out front
	 *	if the Rational is negative.
	 */
